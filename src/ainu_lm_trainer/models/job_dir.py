...
class JobDir:
    """
    A wrapper around GCS blob as they don't have a concept of directories.
    """

    __blob: Blob

    def __init__(self, job_dir: str) -> None:
        # AIP_MODEL_DIR has a trailing slash
    ...
    def to_blob(self, client: Optional[storage.Client]) -> Blob:
