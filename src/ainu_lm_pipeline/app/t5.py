...
from ..pipelines import ainu_t5_pipeline
from .get_timestamp import get_timestamp

if __name__ == "__main__":
    compiler = Compiler()
    compiler.compile(
        pipeline_func=ainu_t5_pipeline,
        package_path="./dist/ainu_t5_pipeline.yaml",
        pipeline_parameters={
            "project_id": "neetlab",
            ...
            "hf_model_repo": "aynumosir/t5-base-ainu",
    ...
    pipeline_job = PipelineJob(
        ...
        template_path="./dist/ainu_t5_pipeline.yaml",
        job_id=f"ainu-lm-t5-{get_timestamp()}",
