...
from ..components import common, get_mt5_gec_training_job_spec
...
def ainu_mt5_gec_pipeline(
    ...
    get_mt5_gec_training_job_spec_op = (
        ...
        .set_display_name("mT5（文法誤り訂正）訓練ジョブの仕様を取得")
    )
    ...
    CustomTrainingJobOp(
        project=project_id,
        display_name=f"ainu-lm-mt5-gec-{training_job_suffix}",
    ...
    ).set_display_name("mT5（文法誤り訂正）の訓練")
